...
water_data = {"DATE" : pd.date_range(start="2008", end="2023", freq="6M"),
              "WF" : [0.002071, 0.002071, 0.002038, 0.002038, 0.0020325, 0.0020325, 0.002027, 0.002027, 0.002027, 0.002027, 0.002027, 0.002027, 0.001694, 0.001694, 0.001694, \
                      0.001694, 0.001694, 0.001694, 0.001694, 0.001694, 0.001694, 0.001694, 0.001694, 0.001694, 0.001694, 0.001694, 0.001694, 0.001694, 0.001694, 0.001694],

        #     "VAT" : [0.145, 0.145, 0.143, 0.143, 0.142, 0.142, 0.142, 0.142, 0.142, 0.142, 0.142, 0.142, 0.119, 0.119, 0.119, \
        #              0.119, 0.119, 0.119, 0.119, 0.119, 0.119, 0.119, 0.119, 0.119, 0.085, 0.085, 0.119, 0.119, 0.119, 0.119],

              "WWF" : [0.002567, 0.002567, 0.002543, 0.002543, 0.002504, 0.002504, 0.002464, 0.002464, 0.002464, 0.002464, 0.002464, 0.002464, 0.002464, 0.002464, 0.002307, \
                       0.002307, 0.002303, 0.002303, 0.002303, 0.002303, 0.00221, 0.00221, 0.00221, 0.00221, 0.00221, 0.00221, 0.00221, 0.00221, 0.002155, 0.002155]
             }
...
data_elc = {
        "DATE"    : pd.date_range(start="2004", end="2023-07-31", freq="6M", inclusive="left"),
        "no_tax"  : [0.0764, 0.0793, 0.0840, 0.0877, 0.0949, 0.0963, 0.1003, 0.0832, \
                     ...
                     0.1206, 0.1271, 0.1267, 0.1349, 0.1768, 0.1939, 0.1905],
        }

# data_nw_elc: elc. data from EUROSTAT used elc. from 50 Mio kWh/a
data_nw_elc = {
        "DATE"    : pd.date_range(start="2004", end="2018-07-31", freq="6M", inclusive="left"),
        "no_tax"  : [0.0764, 0.0793, 0.0840, 0.0877, 0.0949, 0.0963, 0.1003, 0.0832, \
                     0.0900, 0.0899, 0.0942, 0.0901, 0.0878, 0.0957, 0.1002, 0.1091, \
                     0.1040, 0.1049, 0.1123, 0.1118, 0.1158, 0.1117, 0.1111, 0.1124, \
...
data_20 = {
        "DATE" : pd.date_range(start="1998", end="2023-07-31", freq="6M", inclusive="left"),
...
data_70_150 = {
        "DATE"    : pd.date_range(start="2007", end="2023-07-31", freq="6M", inclusive="left"),
